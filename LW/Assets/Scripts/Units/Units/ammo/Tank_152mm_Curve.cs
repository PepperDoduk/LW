...
public class Tank_152mm_Curve : MonoBehaviour
{
    [Header("Classes")]
    ...
    {
            rb.gravityScale = 2f;
            rb.AddForce(Vector2.up * fireForce * Random.Range(1.65f, 2.05f), ForceMode2D.Impulse);
            rb.AddForce(Vector2.right * fireForce * Random.Range(1.45f, 1.65f), ForceMode2D.Impulse);
    }
